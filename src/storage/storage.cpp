...
void NunchukStorage::Init(const std::string& datadir,
  ...
  if (bfs::create_directories(datadir_ / "testnet")) {
    bfs::create_directories(datadir_ / "testnet" / "wallets");
    bfs::create_directories(datadir_ / "testnet" / "signers");
  }
  if (bfs::create_directories(datadir_ / "mainnet")) {
    bfs::create_directories(datadir_ / "mainnet" / "wallets");
    bfs::create_directories(datadir_ / "mainnet" / "signers");
  }
  if (bfs::create_directories(datadir_ / "signet")) {
    bfs::create_directories(datadir_ / "signet" / "wallets");
    bfs::create_directories(datadir_ / "signet" / "signers");
  }
  bfs::create_directories(datadir_ / "tmp");
}
...
bfs::path NunchukStorage::GetTapprotocolDir(Chain chain) const {
...
NunchukTapprotocolDb NunchukStorage::GetTaprotocolDb(Chain chain) {
  bfs::path db_file = GetTapprotocolDir(chain);
  bool is_new = !bfs::exists(db_file);
